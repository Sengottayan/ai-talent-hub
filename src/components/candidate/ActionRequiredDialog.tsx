...
export function ActionRequiredDialog({ open, onOpenChange, rescheduleRequest, onSuccess }: ActionRequiredDialogProps) {
    ...
    const handleConfirm = async () => {
        ...
        try {
            await axios.post(`${API_URL}/reschedule/${rescheduleRequest._id}/candidate-confirm`, {
            ...
            toast({
                title: "Error",
                description: error.response?.data?.message || "Failed to confirm interview.",
                variant: "destructive",
            });
        } finally {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Your requested time was not available. Please select one of the following alternative slots proposed by our team for your <strong>{jobRole}</strong> interview.
                    </DialogDescription>
                </DialogHeader>
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <CalendarIcon className={`h-5 w-5 ${isSelected ? 'text-primary' : 'text-muted-foreground'}`} />
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleConfirm} disabled={!selectedDate || isSubmitting}>
