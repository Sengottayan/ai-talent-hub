...
const sidebarItems = [
  ...
  { icon: Briefcase, label: "Post Job", href: "/hr/upload" },
  { icon: Video, label: "Interviews", href: "/hr/interviews" },
  { icon: Calendar, label: "Reschedule", href: "/hr/reschedule" },
  { icon: BarChart2, label: "Results", href: "/hr/results" },
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-sidebar text-sidebar-foreground">
      <div className="p-6">
        <Link
          to="/"
          className="text-xl font-bold flex items-center gap-2 text-sidebar-foreground hover:scale-105 transition-transform"
        >
