    ...
    try {
      ...
      if (data.success) {
        ...
        toast({
          ...
          description:
            "Your skill gap analysis has been saved to your history.",
        });
      ...
      toast({
        ...
        description:
          error.response?.data?.message || "Error analyzing skill gap.",
        variant: "destructive",
      });
    } finally {
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">
            Compare your resume against any job role and track your progress.
          </p>
        </div>
        <Button
          variant="outline"
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card className="border-primary/10 shadow-sm h-fit">
            <CardHeader>
              ...
              <CardDescription>
                Specify the role you want to analyze against.
              </CardDescription>
            </CardHeader>
            ...
            {!results ? (
              <Card className="h-full border-dashed flex flex-col items-center justify-center p-12 text-center bg-muted/20">
                ...
                <p className="text-sm text-muted-foreground">
                  Analyze a new role or check your{" "}
                  <span
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs font-medium opacity-80 uppercase tracking-wider">
                          Analysis for {results.targetRole}
                        </p>
