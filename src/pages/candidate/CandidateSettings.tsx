    ...
    try {
      ...
      if (data.success) {
        toast({
          title: "Resume Synced",
          description:
            "Your resume profile data has been successfully analyzed and updated.",
        });
      }
    } catch (error: any) {
      toast({
      ...
      <div className="grid gap-6 md:grid-cols-2">
              ...
              <Switch
                ...
                onCheckedChange={(val) => {
                  ...
                  toast({
                    ...
                    description: `Email alerts ${val ? "enabled" : "disabled"}`,
                  });
                }}
              />
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Upload your latest resume to update your profile data.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              {isUploadingResume ? (
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium mb-4">
                    Select a PDF or DOCX file to sync latest skills
                  </p>
                  <Button
