...
const features = [
  {
    ...
    description:
      "Automatically evaluate resumes and match candidates to job requirements with intelligent scoring.",
  },
  {
    icon: Video,
    title: "Smart Interviews",
    description:
      "Conduct AI-driven interviews that assess technical skills and communication abilities.",
  },
  {
    icon: Calendar,
    title: "Automated Scheduling",
    description:
      "Let our system handle interview scheduling and rescheduling requests seamlessly.",
  },
  {
    icon: FileText,
    title: "Detailed Analytics",
    description:
      "Get comprehensive reports and insights on candidate performance and hiring metrics.",
  },
];
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="hidden sm:flex items-center gap-2">
              <Button
                variant="ghost"
                asChild
                className="text-muted-foreground hover:text-primary hover:bg-primary/10 px-3"
              >
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="mx-auto max-w-4xl text-center animate-fade-in">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground sm:text-xl leading-relaxed">
              Stop wasting hours on manual screening. Our AI agents evaluate
              resumes and conduct interviews to find your star talent instantly.
            </p>
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Button
                size="lg"
                asChild
                className="w-full sm:w-auto px-8 bg-primary hover:bg-primary/90 text-primary-foreground shadow-xl shadow-primary/25 h-14 text-base font-bold transition-all hover:scale-105 active:scale-95"
              >
                <Link to="/signup">
                  Start Hiring Free
              ...
              <Button
                ...
                variant="outline"
                asChild
                className="w-full sm:w-auto px-8 border-border text-foreground hover:bg-muted h-14 text-base font-semibold"
              >
          ...
          <div className="mx-auto mt-20 grid max-w-5xl grid-cols-2 gap-4 sm:gap-8 md:grid-cols-4 px-4 sm:px-0">
            {stats.map((stat, index) => (
              ...
              >
                <p className="text-3xl font-black text-primary md:text-4xl lg:text-5xl group-hover:scale-110 transition-transform">
                  {stat.value}
                </p>
      ...
      <section
        id="features"
        className="bg-card/50 py-24 border-y border-border"
      >
        <div className="container mx-auto px-4 md:px-8">
          <div className="mb-16 text-center space-y-4">
            ...
            <p className="mx-auto max-w-2xl text-muted-foreground text-lg">
              We've automated the tedious parts of recruitment so you can focus
              on making final hiring decisions.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "Simply upload your candidate resumes and the system parses them instantly.",
                },
                {
                  step: "02",
                  title: "AI Selection",
                  description:
                    "AI evaluates skills and experience to find the top 5% of your pipeline.",
                },
                {
                  step: "03",
                  title: "Automated Interviews",
                  description:
                    "Interviews are scheduled and conducted by our AI agents automatically.",
                },
              ].map((item, index) => (
                <div
                  key={item.step}
          ...
          <div className="w-full max-w-4xl grid sm:grid-cols-2 gap-4">
            {rules.map((rule, index) => (
              ...
              >
                ...
                <p className="text-sidebar-foreground font-medium text-sm leading-snug">
                  {rule}
                </p>
              </div>
            ))}
          ...
          <div className="mx-auto max-w-5xl rounded-[3rem] bg-gradient-to-br from-primary via-blue-600 to-indigo-700 p-8 md:p-16 text-center text-primary-foreground shadow-[0_20px_50px_rgba(37,99,235,0.3)] relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="mb-10 text-lg opacity-90 text-primary-foreground/90 max-w-2xl mx-auto leading-relaxed">
                Join forward-thinking companies who have already cut their
                time-to-hire by 70%.
              </p>
              <div className="flex flex-col items-center justify-center gap-6 sm:flex-row">
                <Button
                  ...
                  variant="secondary"
                  asChild
                  className="w-full sm:w-auto px-10 h-14 bg-white text-primary hover:bg-white/90 text-lg font-bold rounded-2xl shadow-xl transition-all hover:scale-105 active:scale-95"
                >
                  <Link to="/signup">
                    Get Started Free
                    <ArrowRight className="ml-2 h-5 w-5" />
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto px-10 h-14 bg-transparent border-white/30 text-white hover:bg-white/10 text-lg font-bold rounded-2xl"
                  asChild
                >
                  <Link to="/login">Sign In</Link>
                </Button>
