...
export default function CandidateInterviewPrep() {
  ...
  const requestPermissions = async () => {
    ...
    try {
      ...
      setCameraPermission(
        hasVideo ? "granted" : isLocal ? "pending" : "denied",
      );
      ...
      if (hasVideo && hasAudio) {
        ...
        toast.warning(
          "Mock mode: Proceeding without full hardware (Local Dev Only)",
        );
      }
      ...
      if (
        ...
        toast.error(
          "Permissions denied. Please enable camera/mic in your browser address bar.",
        );
      } else if (error.message === "NoCameraFound") {
        setCameraPermission("denied");
        toast.error(
          "No camera detected. A camera is mandatory for this interview.",
        );
      } else if (error.name === "NotFoundError") {
        toast.error(
          "Hardware not found. Please connect your camera and microphone.",
        );
      } else {
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-600">
                        Switching tabs may be flagged as suspicious activity
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-600">
                        Answer questions naturally and at a moderate pace
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-600">
                        Relax and showcase your authentic skills
                      </div>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-3">
                  ...
                  {(cameraPermission !== "granted" ||
                    ...
                    <div className="text-sm text-amber-600 bg-amber-50 p-3 rounded-lg border border-amber-200">
                      <strong>Action Required:</strong> If devices are not
                      active, please permit Camera & Microphone in your browser
                      (lock icon), then click Retry.
                    </div>
                  )}
              ...
              <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-amber-800">
                    ...
                    <div>
                      This interview will be recorded and monitored. Ensure
