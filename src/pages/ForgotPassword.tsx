...
import { Bot, Mail, Lock, ArrowRight, Loader2, ArrowLeft, Eye, EyeOff } from "lucide-react";
...
export default function ForgotPassword() {
    ...
    const handleResetPassword = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({
                title: "Reset Failed",
                description: error.response?.data?.message || "Failed to reset password. Please check your email.",
                variant: "destructive",
            });
        } finally {
            setIsLoading(false);
