            ...
            {processedRequests.length > 0 ? (
              processedRequests.map((request) => {
                ...
                return (
                  <div
                    key={request._id}
                    className="flex flex-col gap-4 rounded-xl border border-border p-4 sm:flex-row sm:items-center sm:justify-between transition-colors hover:bg-muted/30"
                  >
                    <div className="flex items-center gap-4">
              ...
              <p className="text-center py-6 text-sm text-muted-foreground">No processed requests found</p>
            )}
          </div>
        </CardContent>
      </Card>
